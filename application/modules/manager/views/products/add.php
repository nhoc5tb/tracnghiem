                ...
                <div class="panel-body">
                  ...
                  <form action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input style="width:150px" placeholder="Mã EAN" class="form-control" name="code_aen" value="<?php echo set_value('code_aen');?>" type="text">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input style="width:150px" placeholder="" class="form-control" name="code" value="<?php echo set_value('code');?>" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea type="text" class="form-control" name="keywords"><?php echo set_value('keywords');?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <!--- add thuong hieu -->
                        <button class="btn btn-space btn-primary btn-lg open-trademark" type="submit" data-toggle="modal" data-target="#mod-trademark">Thêm Thương Hiệu</button>                        
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                      	<div class="input-group xs-mb-10" style="max-width:500px">
							...
							<input type="text" value="<?php echo set_value('price');?>" class="form-control" name="price"><span class="input-group-addon">VNĐ</span>
                      	</div>
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Mặt hàng mua chung</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea class="form-control" name="home_text" style="height: 200px;"><?php echo set_value('home_text');?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-sm-12">                       		
							...
							$this->load->view("blockmodule/froalaeditor.php",array("name"=>"body_text","content_froalaeditor"=>set_value('body_text')));
							?>                            
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                            ...
                            <button class="btn btn-primary" type="submit" value="true" name="attrib">Lưu & Nhập Thuộc Tính</button>
...
<!--add thuong hieu-->
                        <div id="mod-trademark" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" placeholder="" class="form-control trademark-name">
                                </div>
                                <div class="form-group">
                                  <label>Logo Thương Hiệu</label>
                                  <input type="file" class="trademark-file" class="form-control">
                                  <div class="img-thumbnail" style="display: none">
                                    <img src="" class="trademark-img" style="max-width: 200px;">
                                  </div>  
                                </div>
                                <div class="form-group">
                                  <label>Xuất xứ</label>
                                  <select class="select2 trademark-origin" >
              ...
              <option value="Zimbabwe">Zimbabwe</option>
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="button" id="trademark-submit" class="btn btn-primary">Thêm Thương Hiệu</button>
                              </div>
                            </div>
                          </div>
                        </div>
