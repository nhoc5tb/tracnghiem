...
<div class="panel panel-default panel-table">
	<div class="panel-heading panel-heading-divider"><?php echo $controller_title ?><span class="panel-subtitle"><?php echo $controller_title ?></span></div>
                ...
                <div class="panel-body">
                  ...
                  <form action="<?php echo base_url().$module.'/'.$controller.'/add' ?>"  style="border-radius: 0px;" class="form-horizontal group-border-dashed"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input name="order" value="0" value="<?php if(!empty($getcsdl) && !validation_errors()) echo $getcsdl->order;else echo set_value('order');?>" style="width:100px" min="0" max="100" class="form-control" type="number">
                      </div>
                    </div>
