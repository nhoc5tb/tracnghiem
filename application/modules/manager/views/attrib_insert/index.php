...
<div class="panel panel-default panel-table">
	<div class="panel-heading panel-heading-divider">Thuộc Tính Nhập<span class="panel-subtitle">Danh sách thuộc tính nhập</span></div>
        ...
        <table class="table table-striped table-hover">
            ...
            <?php foreach($getcsdl as $key=>$row):?>
                <tr id="id<?php echo $row->id ?>">
                    <td align="center"><strong>#<?php echo $key ?></strong></td>
