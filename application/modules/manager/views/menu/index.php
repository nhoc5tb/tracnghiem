...
<div class="panel panel-default panel-table">
	<div class="panel-heading panel-heading-divider">Danh Mục Tin Tức<span class="panel-subtitle">Phân nhóm cho nhập liệu tin tức</span></div>
            ...
            <?php foreach($catalogs as $row):?>
                <tr id="id<?php echo $row->id ?>">
                    ...
                    <td>
                      ...
                      <?php if($row->fixed != 1): ?>  <?php echo $this->rurole->showPermission("delete",$row->id) ?> <?php endif ?>
                    </td>
                </tr>
            <?php endforeach ?>
            </tbody>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Thêm Menu</div>
                <div class="panel-body">
                  ...
                  <form action="<?php echo base_url().$module.'/'.$controller.'/add' ?>"  style="border-radius: 0px;" class="form-horizontal group-border-dashed"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                      		<button class="btn btn-primary btn-lg" type="submit">Thêm</button>
