...
<div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Thêm Tin Tức<span class="panel-subtitle">Thêm nội dung tin tức cho website</span></div>
                <div class="panel-body">
                  ...
                  <form action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label text-success">Tiêu đề</label>
                      <div class="col-sm-9">
                      ...
                      <div class="col-sm-9">
                      	<select class="select2" name="catalog">
                              <?php	foreach($catalogs as $row){
										echo '<option value="'.$row->id.'" '.set_select('catalog', $row->id, (!empty($getcsdl) && $getcsdl->catalog == $row->id)).'>'.$row->title.'</option>';
								}
							?>
						</select>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea class="form-control" name="home_text"><?php if(!empty($getcsdl) && !validation_errors()) echo $getcsdl->home_text;else echo set_value('home_text');?></textarea>
                      </div>
                    </div>
